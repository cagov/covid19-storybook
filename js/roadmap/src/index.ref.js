...
//         aList.push(item['activity_search_autocomplete'])
//       })
...
//         if(ac["activity_search_autocomplete"] == this.state['activity'] || this.state['activity'] == this.viewall) {
...
//             <h4>${ac["activity_search_autocomplete"]}</h4>
//             <p>${ac["RSHO"]}</p>
//             <p>${ac["Guidance"].indexOf('href') > -1 ? `${this.json.seeGuidanceText} ${replaceAllInMap(ac["Guidance"])}` : ""}</p>
//           </div>`
//         } else {
//           this.cardHTML += `<div class="card-activity">
//             <h4>${ac["activity_search_autocomplete"]}</h4>
//             <p>${ac[localTierStatus]}</p>
//             <p>${ac["Guidance"].indexOf('href') > -1 ? `${this.json.seeGuidanceText} ${replaceAllInMap(ac["Guidance"])}` : ""}</p>
...
// window.customElements.define('cagov-reopening-airtable', CAGovReopening);
